...
`, newLVMClusterName, lvmsNamespace, deviceClassName, diskPath)
		...
		o.Expect(err.Error()).To(o.ContainSubstring("topolvm.io/device-class"), "Error should mention the reserved key")
...
`, newLVMClusterName, lvmsNamespace, deviceClassName, diskPath)
		...
		o.Expect(err.Error()).To(o.ContainSubstring("csi.storage.k8s.io/fstype"), "Error should mention the reserved key")
...
`, newLVMClusterName, lvmsNamespace, deviceClassName, diskPath)
		...
		o.Expect(string(output)).To(o.ContainSubstring("invalid"))
